...
class RegionRequirement():
    ...
    def init_code(self, requirement_num, launcher_name, parent_name):
        rr = cpp_funcall('RegionRequirement', [], [self.region.name, self.privilege, self.coherence, parent_name])
